      ...
      {messageHistory.length == 0 && !session?.loading && (
       ...
       >
        <Box textAlign="center">
            This is a Generative AI experimental tool that may not always be accurate. Verify key information using the tool’s provided sources before giving a response to residents.
            <br />
            <br />
