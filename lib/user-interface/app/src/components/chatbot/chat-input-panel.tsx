    ...
    <SpaceBetween direction="vertical" size="l">
      <Container>
        <div className={styles.input_textarea_container}>
          ...
          <TextareaAutosize id="message-input-textarea"
          ...
          <div style={{ marginLeft: "8px" }}>
            <Button
              ...
              ariaControls="message-input-textarea"
              variant="primary"
            >
              {props.running ? (
                <>
