...
//      const dismissButton = document.querySelector('.awsui_dismiss-button_1q84n_1w478_170.awsui_button_vjswe_1tt9v_153.awsui_variant-flashbar-icon_vjswe_1tt9v_247.awsui_button-no-text_vjswe_1tt9v_1133');
    ...
    if (!dismissButtons) {
        console.log("OnUpload->file-upload-tab: Dismiss Buttons not found");
    }
    dismissButtons.forEach((dismissButton, index) => {
        dismissButton.setAttribute('aria-label', 'Dismiss message button'); 
        console.log(`OnUpload->file-upload-tab: Set aria-label to Dismiss Button ${index + 1}:`, dismissButton.getAttribute('aria-label')); 
    });
    ...
    if (flashFocusContainer) {
        ...
        console.log('OnUpload->file-upload-tab: Flash focus container not found');
    }
...
//      const dismissButton = document.querySelector('.awsui_dismiss-button_1q84n_1w478_170.awsui_button_vjswe_1tt9v_153.awsui_variant-flashbar-icon_vjswe_1tt9v_247.awsui_button-no-text_vjswe_1tt9v_1133');
      ...
      dismissButtons.forEach((dismissButton, index) => {
          dismissButton.setAttribute('aria-label', 'Dismiss message button'); 
          console.log(`useEffect->file-upload-tab: Set aria-label to Dismiss Button ${index + 1}:`, dismissButton.getAttribute('aria-label'));  
      });
      ...
      if (flashFocusContainer) {
          ...
          console.log('useEffect->file-upload-tab: Flash focus container not found');
      }
//      const statusIcon = document.querySelector('.awsui_flash-icon_1q84n_1w478_193.awsui_flash-text_1q84n_1w478_824');
//      if (statusIcon) {
//          statusIcon.setAttribute('aria-label', 
