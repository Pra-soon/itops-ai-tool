...
export class UserInterface extends Construct {
  constructor(scope: Construct, id: string, props: UserInterfaceProps) {
    ...
    const websiteKey = new kms.Key(this, "WebsiteKey", {
      enableKeyRotation: true,    
      description: "KMS key for OAC to access websiteBucket",
      alias: cdk.Stack.of(this).stackName + '/WebsiteKey',    
    });
    ...
    const publicWebsite = new Website(this, "Website", { ...props, websiteBucket: websiteBucket, websiteKey: websiteKey });
